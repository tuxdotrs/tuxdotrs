...
- [jamiepine/voicebox](https://github.com/jamiepine/voicebox) (1 day ago) - The open-source voice synthesis studio powered by Qwen3-TTS.
- [railwayapp/railpack](https://github.com/railwayapp/railpack) (6 days ago) - Zero-config application builder that automatically analyzes and turns your code into an image
