...
- [serenity-rs/serenity](https://github.com/serenity-rs/serenity) (today) - A Rust library for the Discord API.
- [serenity-rs/poise](https://github.com/serenity-rs/poise) (today) - Discord bot command framework for serenity, with advanced features like edit tracking and flexible argument parsing
- [panjf2000/gnet](https://github.com/panjf2000/gnet) (3 days ago) - 🚀 gnet is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) (5 days ago) - LLM inference in C/C&#43;&#43;
