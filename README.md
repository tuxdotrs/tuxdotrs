...
- [tuxdotrs/nix-config](https://github.com/tuxdotrs/nix-config) - My entire infrastructure in a nix flake. (4 months ago)
...
- [fzakaria/trynix](https://github.com/fzakaria/trynix) (1 day ago) - Boot anything nixpkgs ever shipped, in your browser.
