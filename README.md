...
- [westpoint-io/lazyrsync](https://github.com/westpoint-io/lazyrsync) (today) - 🦀 A friendly terminal UI for rsync, written in Rust. Reusable profiles, an honest dry-run diff, and live progress, even over SSH.
