...
- [matheus-git/systemd-manager-tui](https://github.com/matheus-git/systemd-manager-tui) - A program for managing systemd services through a TUI (Terminal User Interfaces). (2 days ago)
...
- [rgwood/systemctl-tui](https://github.com/rgwood/systemctl-tui) (3 days ago) - A fast, simple TUI for interacting with systemd services and their logs
