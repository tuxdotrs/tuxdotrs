...
- [serenity-rs/serenity](https://github.com/serenity-rs/serenity) (4 days ago) - A Rust library for the Discord API.
- [serenity-rs/poise](https://github.com/serenity-rs/poise) (4 days ago) - Discord bot command framework for serenity, with advanced features like edit tracking and flexible argument parsing
