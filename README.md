...
- [tuxdotrs/tshell](https://github.com/tuxdotrs/tshell) - My widgets for wayland (Quickshell) (2 weeks ago)
- [tuxdotrs/nix-config](https://github.com/tuxdotrs/nix-config) - My entire infrastructure in a nix flake. (2 weeks ago)
- [tuxdotrs/tnvim](https://github.com/tuxdotrs/tnvim) - My nvim configuration (3 weeks ago)
- [tuxdotrs/tpanel](https://github.com/tuxdotrs/tpanel) - My widgets for wayland (AGS) (3 weeks ago)
- [tuxdotrs/trok](https://github.com/tuxdotrs/trok) - Accessing your local service should be simple (4 weeks ago)

#### 🌱 My latest projects

- [tuxdotrs/tshell](https://github.com/tuxdotrs/tshell) - My widgets for wayland (Quickshell)
- [tuxdotrs/highminded](https://github.com/tuxdotrs/highminded) - Undetectable AI that helps you with meetings
- [tuxdotrs/tpanel](https://github.com/tuxdotrs/tpanel) - My widgets for wayland (AGS)
...
- [jtroo/kanata](https://github.com/jtroo/kanata) (3 weeks ago) - Improve keyboard comfort and usability with advanced customization
- [iced-rs/iced](https://github.com/iced-rs/iced) (3 weeks ago) - A cross-platform GUI library for Rust, inspired by Elm
- [mangowm/mango](https://github.com/mangowm/mango) (4 weeks ago) - Practical and Powerful wayland compositor (dwm but wayland)
- [jamiepine/voicebox](https://github.com/jamiepine/voicebox) (1 month ago) - The open-source voice synthesis studio
- [railwayapp/railpack](https://github.com/railwayapp/railpack) (1 month ago) - Zero-config application builder that automatically analyzes and turns your code into an image
