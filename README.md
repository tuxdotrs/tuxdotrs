...
- [tuxdotrs/nix-config](https://github.com/tuxdotrs/nix-config) - My entire infrastructure in a nix flake. (1 month ago)
...
- [ogulcancelik/herdr](https://github.com/ogulcancelik/herdr) (3 weeks ago) - agent multiplexer that lives in your terminal.
