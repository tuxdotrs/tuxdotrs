...
- [matheus-git/systemd-manager-tui](https://github.com/matheus-git/systemd-manager-tui) - A program for managing systemd services through a TUI (Terminal User Interfaces). (5 days ago)
...
- [rgwood/systemctl-tui](https://github.com/rgwood/systemctl-tui) (6 days ago) - A fast, simple TUI for interacting with systemd services and their logs
